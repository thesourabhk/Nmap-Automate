...
os.system('clear')
time.sleep(1) 
cprint(figlet_format('Auto Nmap', font='starwars'), 'yellow', attrs=['bold'])

name = colored('''	Developed by:SourabhKumar  Twitter: @Sourabh_k_d''', 'blue', attrs=['bold'])
version = colored('''		Version 1.0''', 'blue', attrs=['bold'])
print version
